      ...
      <div className='flex flex-col h-full py-6'>
        <nav className="flex-col flex h-full items-start px-2 text-sm font-medium lg:px-4 gap-3">
          ...
          <Link
            ...
            className={`flex w-full items-center gap-3 rounded-lg px-3 py-2 transition-all ${userData?.papel === 'Gerente' ? (isActive('/collaborators') ? 'bg-muted text-primary' : 'text-muted-foreground') : 'text-neutral-500 cursor-not-allowed'} `}
